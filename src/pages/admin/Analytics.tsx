      ...
      <div className="grid gap-5 md:grid-cols-2 2xl:grid-cols-4">
        <Card className="px-10">
          <div className="flex items-center gap-5 md:flex-col xl:flex-row">
            ...
            <div className="flex flex-col md:text-center xl:text-left">
              <span className="font-bold text-xl md:text-2xl">Total Users</span>
        ...
        <Card className="px-10">
          <div className="flex items-center gap-5 md:flex-col xl:flex-row">
            <UserIcon size={50} />
            <div className="flex flex-col md:text-center xl:text-left">
              <span className="font-bold text-xl md:text-2xl">Total Agents</span>
        ...
        <Card className="px-10">
          <div className="flex items-center gap-5 md:flex-col xl:flex-row">
            <WalletIcon size={50} />
            <div className="flex flex-col md:text-center xl:text-left">
              <span className="font-bold text-xl md:text-2xl">Transaction</span>
        ...
        <Card className="px-10">
          <div className="flex items-center gap-5 md:flex-col xl:flex-row">
            <Coins size={50} />
            <div className="flex flex-col md:text-center xl:text-left">
              <span className="font-bold text-xl md:text-2xl">Total Profit</span>
